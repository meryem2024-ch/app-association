...
<body>
    ...
    <div class="container">
        <h1>Ajouter une nouvelle association pour la ville : <?php echo e($ville->nom); ?></h1>
        ...
        <form action="<?php echo e(route('association.store', $ville->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact" name="contact" value="<?php echo e(old('contact')); ?>">
            </div>

            <button type="submit">Ajouter l'association</button>
        </form>

        <a href="<?php echo e(route('ville.associations', $ville->id)); ?>">Retour aux associations</a>
    </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\App\resources\views/create-association.blade.php ENDPATH**/ ?>