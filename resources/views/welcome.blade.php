...
<body>
    <header>
        ...
        <div class="buttons">
            ...
            @else
                <a href="{{ route('login') }}" class="btn"><i class="fas fa-sign-in-alt"></i> Se connecter</a>
            @endauth
        </div>
    </header>
    ...
    <div class="container">
        ...
        @auth
            <div class="welcome-message">Bonjour, {{ Auth::user()->name }} !</div>
        @endauth

        <h2 style="margin-bottom: 30px;">Liste des Villes</h2>
        <div class="card-container">
            @foreach ($villes as $ville)
                <div class="card" style="background-image: url('{{ asset('images/' . strtolower(str_replace('é', 'e', $ville->nom)) . '.jpg') }}');">
                    <div class="card-content">
                        <h3>{{ $ville->nom }}</h3>
                        <a href="{{ route('ville.associations', $ville->id) }}">
